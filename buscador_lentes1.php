...
<body>
  ...
  <main id="main">
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <a href="listadodelentes.php" class="btn btn-primary"><i class="bi bi-arrow-left"></i></a>
            <!-- Formulario -->
            <div class="form-row">
                <center><form action="buscador_lentes1.php" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="rutp"><h6>Nombre del marco</h6></label>
                        <input type="text"  class="form-control" name="nombremarco" id="nombremarco" placeholder="OPCION 1" autocomplete="off" 
            ...
            <?php echo "
               ...
               ?>
                <?php
                    ...
                    $nombremarco=$_REQUEST['nombremarco'];

                    $sql = "select * from marcos where nombremarco='$nombremarco' order by id_marcos";
                    ...
                    if ($result->num_rows > 0) {
                      while($row = $result->fetch_assoc()) {
                        ...
                        echo("<br><center><h3> El lente está mal escrito o no existe</h3></center>");
                    }
                    $conexion->close();
